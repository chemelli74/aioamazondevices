...
from aioamazondevices.implementation.device import _build_endpoint_device
...
def build_light_from_appliance(
    ...
    if appliance.get("manufacturerName") != "Amazon":
        return None
    if LIGHT_FAMILY not in (appliance.get("applianceTypes") or []):
        return None
