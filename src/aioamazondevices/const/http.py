...
REQUEST_AGENT = {
    ...
    "Browser": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36 Edg/152.0.0.0",  # noqa: E501
}
...
URI_PHOENIX_STATE = "api/phoenix/state"
